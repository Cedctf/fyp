        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-[rgb(27,55,121)]/70 font-medium">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-semibold uppercase tracking-widest text-[rgb(27,55,121)]/70 mb-2">
                Full name
              </label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[rgb(27,55,121)]/70" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              <label htmlFor="address" className="block text-sm font-semibold uppercase tracking-widest text-[rgb(27,55,121)]/70 mb-2">
                Address
              </label>
              <div className="relative">
                <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[rgb(27,55,121)]/70" />
                <input
                  id="address"
                  type="text"
                  value={address}
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-semibold uppercase tracking-widest text-[rgb(27,55,121)]/70 mb-2">
                Phone Number
              </label>
              <div className="relative">
                <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[rgb(27,55,121)]/70" />
                <input
                  id="phone"
                  type="tel"
                  value={phone}
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[rgb(27,55,121)]/60">Must be at least 8 characters</p>
            </div>

            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold uppercase tracking-widest text-[rgb(27,55,121)]/70 mb-2">
                Confirm password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[rgb(27,55,121)]/70" />
          ...
          <p className="text-center text-sm text-[rgb(27,55,121)]/70">
            ...
            <Link href="/auth/signin" className="font-medium text-[rgb(27,55,121)] hover:text-[rgb(27,55,121)]/80 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
