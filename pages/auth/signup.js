    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-12">
      <div className="w-full max-w-5xl rounded-2xl bg-white shadow-xl overflow-hidden">
        <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-gray-200">
          {/* Left info panel */}
          <div className="hidden md:flex w-full md:w-1/2 p-8 items-center justify-center bg-gray-50/50">
            <div className="w-full max-w-md space-y-6 text-center">
              <div className="mx-auto mb-6 flex h-40 w-40 items-center justify-center overflow-hidden rounded-xl bg-white ring-1 ring-slate-100 shadow-sm">
                <img
              ...
              <p className="mt-3 text-sm text-slate-600 px-8">
                Create your account to get started with our guided onboarding process.
              </p>
