...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-12 flex items-center justify-center">
      <motion.div
      ...
      >
        <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-gray-200">
          ...
          <div className="w-full md:w-1/2 p-8 flex items-center justify-center">
            <div className="w-full max-w-md min-h-[520px] flex flex-col items-center justify-center space-y-6 text-center">
              ...
              <p className="mt-3 text-sm text-slate-600">
                Jump back into your dashboard and continue right where you left
                off.
              </p>
          ...
          {/* Right sign-in form */}
          <motion.div
            className="w-full md:w-1/2 p-8 space-y-8"
          ...
          >
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="flex w-full items-center justify-center gap-3 rounded-lg border-2 border-gray-300 bg-white px-4 py-3 font-medium text-gray-700 transition-all hover:bg-gray-50 hover:border-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
              >
