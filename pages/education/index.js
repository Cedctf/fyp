                    ...
                    <section className="mb-32">
                        <div className="grid md:grid-cols-2 gap-15 items-center">
                            ...
                            <div className="space-y-10">
                                <h2 className="text-3xl md:text-4xl font-serif font-light text-[rgb(27,55,121)] leading-[1.1] max-w-2xl">
                    ...
                    <div className="space-y-12">
                        {otherArticles.map((article, index) => (
                            <motion.div
                                ...
                                className="group grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-b border-[rgb(27,55,121)]/5 pb-12 last:border-0"
                            >
                                {/* Date - Left Column */}
                                ...
                                <div className="md:col-span-7 flex flex-col items-start gap-4">
                                    <div className="flex justify-between w-full items-start">
                                        <h3 className="text-3xl font-bold text-[rgb(27,55,121)] group-hover:text-[rgb(87,17,17)] transition-colors cursor-pointer leading-tight font-serif">
                                            {article.title}
                                        </h3>
                                    ...
                                    <p className="text-lg text-[rgb(27,55,121)]/70 leading-relaxed max-w-2xl font-sans">
                                        {article.excerpt}
                                    </p>
